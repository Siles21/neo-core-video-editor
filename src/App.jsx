      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "12px" }}>
          ...
          <div style={Object.assign({}, sec, { padding: "14px", border: "1px solid rgba(108,99,255,0.2)", background: "rgba(108,99,255,0.03)" })}>
              ...
              {Object.entries(AI_PROVIDERS).map(function(entry) {
                ...
                return (
                  <button key={pk} onClick={function() {
                    ...
                    flex: 1, padding: "5px 4px", borderRadius: "5px", cursor: "pointer", fontSize: "10px",
                    border: active ? "2px solid " + C.accent : "1px solid " + C.border,
                    background: active ? C.accentBg : C.card,
                    color: active ? C.accentText : C.dim, fontFamily: "system-ui", fontWeight: active ? 700 : 400,
            ...
            <select value={selectedModel} onChange={function(e) { setSelectedModel(e.target.value); }}
              style={{ width: "100%", padding: "5px 8px", fontSize: "11px", background: "rgba(255,255,255,0.05)",
                color: "#fff", border: "1px solid " + C.border, borderRadius: "4px", outline: "none", marginBottom: "8px" }}>
              {AI_PROVIDERS[selectedProvider].models.map(function(m) {
                return <option key={m} value={m}>{m}</option>;
              })}
            </select>
